...
struct RelapseFormView: View {
    private enum SetbackType: String {
        case lapse
        case relapse
    }
    ...
    @State private var setbackType: SetbackType = .lapse
                    ...
                    ScrollView {
                        VStack(alignment: .leading, spacing: 28) {
                            ...
                            VStack(alignment: .leading, spacing: 12) {
                                ...
                                HStack(spacing: 10) {
                                    setbackTypeButton(type: .lapse, title: "Lapse", subtitle: "One-time mistake")
                                    setbackTypeButton(type: .relapse, title: "Relapse", subtitle: "Back to the addiction")
                                }
                            }
    ...
    private func setbackTypeButton(type: SetbackType, title: String, subtitle: String) -> some View {
        Button {
            setbackType = type
        } label: {
            VStack(alignment: .leading, spacing: 6) {
                Text(title)
                    ...
                    .foregroundStyle(setbackType == type ? AppTheme.charcoal : AppTheme.warmWhite)
                Text(subtitle)
                    .font(.caption)
                    .foregroundStyle(setbackType == type ? AppTheme.charcoal.opacity(0.8) : AppTheme.subtleGray)
            }
            .frame(maxWidth: .infinity, alignment: .leading)
            .padding(12)
            .background(setbackType == type ? AppTheme.terracotta : AppTheme.cardBackground)
